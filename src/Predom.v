...
Lemma fcont_comp_unitR: forall D E (f:D -C-> E), f << (ID _) == f.
intros D E f. apply fcont_eq_intro. auto.
Qed.

Lemma fcont_comp_unitL: forall D E (f:D -C-> E), (ID _) << f == f.
